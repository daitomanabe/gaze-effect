...
The examples below use public domain source images and apply the same eye-contact correction concept to still images. Each pair shows the original image and the corrected output generated by `GazeEffectImageTool`.
...
| Original | Corrected |
| --- | --- |
| ![Cornelius Vanderbilt original](Assets/examples/before/vanderbilt.jpg) | ![Cornelius Vanderbilt corrected](Assets/examples/after/vanderbilt.jpg) |
...
| Original | Corrected |
| --- | --- |
| ![Abraham Lincoln original](Assets/examples/before/loc-lincoln-left.jpg) | ![Abraham Lincoln corrected](Assets/examples/after/loc-lincoln-left.jpg) |
...
| Original | Corrected |
| --- | --- |
| ![Gifford Pinchot original](Assets/examples/before/loc-pinchot.jpg) | ![Gifford Pinchot corrected](Assets/examples/after/loc-pinchot.jpg) |
...
| Original | Corrected |
| --- | --- |
| ![Beverly Page Yates original](Assets/examples/before/loc-yates.jpg) | ![Beverly Page Yates corrected](Assets/examples/after/loc-yates.jpg) |
